...
// CÓDIGO BASE GANADOR (SINTONIZABLE)
// ==========================================
//
// NOTA: esta es la versión ORIGINAL, previa a que se le agregara
// el control por Bluetooth, el término integral Ki y el guardado
// en EEPROM. Se conserva como respaldo y referencia.
// El firmware que se usa es ../rengo.ino
//
// Está en una subcarpeta a propósito: el IDE de Arduino concatena
// todos los .ino que encuentra en la carpeta del sketch, así que si
// este archivo estuviera al lado de rengo.ino no compilaría ninguno.
